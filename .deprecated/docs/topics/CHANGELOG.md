...
* feat(docs): update Pipeline-Standards.md with additional guidelines

Updated the Pipeline-Standards.md file in the docs/topics/pipeline directory. Added a TL;DR section that provides a concise summary of the guidelines for version control, isolated environments, directory structure, data description, and self-documenting code. Also, emphasized the statement about user expectations and formatted a warning about non-adherence to the standards. ([`b98ecc5`](https://github.com/bhklab/ORCESTRA-api/commit/b98ecc5ef4dd58ba82a19649113a6c4da7468c74))

### Unknown

* Merge pull request #46 from bhklab/development

feat(docs): update Pipeline-Standards.md with additional guidelines ([`c379074`](https://github.com/bhklab/ORCESTRA-api/commit/c379074187aee7a6e49ee3fe6bf6e5c41c9c2895))
...
Auto-generated by semantic-release. ([`35b90d9`](https://github.com/bhklab/ORCESTRA-api/commit/35b90d967b50177d3b9931a31005119889b18643))
